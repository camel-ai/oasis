...
<CardGroup cols={2}>
  ...
  >
    Adapts to real-time changes in social networks and content, mirroring the fluid dynamics of <b>Twitter-like</b>, <b>Reddit-like</b>, and <b>short-video</b> platforms for authentic simulation experiences
  </Card>
  <Card
  ...
  >
    Agents can perform a broad set of platform-native actions, such as following, commenting, reposting, uploading videos, and joining livestreams for rich, multi-faceted interactions
  </Card>
  <Card
  ...
  >
    Features <b>interest-based</b>, <b>hot-score-based</b>, and <b>traffic-pool-style</b> recommendation algorithms, simulating how users discover content on modern social media platforms
  </Card>
</CardGroup>
