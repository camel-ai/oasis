...
### Short-Video Agent Profiles (JSON format)

For short-video platforms, agent profiles are typically stored in JSON format with creator/viewer metadata and interest tags:
...
[
  {
    ...
    "name": "Creator One",
    "bio": "Dance creator",
    "persona": "Energetic short-video creator",
    "role": "creator",
