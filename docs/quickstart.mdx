...
<AccordionGroup>
  ...
  <Accordion icon="play" title="Run a Reddit simulation">
    ...
    if __name__ == "__main__":
        asyncio.run(main())
    ```
    This will start a simulation of user interactions in a Reddit-like environment. You can also configure OASIS for Twitter-like or short-video simulations depending on the platform and action set you choose.
  </Accordion>
</AccordionGroup>
