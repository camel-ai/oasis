...
1. **Platform**: The central infrastructure that simulates the social media environment, including Twitter-like, Reddit-like, and short-video platform variants. It manages user accounts, content, social relationships, and engagement metrics.
...
1. **Initialization**:
   - The platform is created with specific settings for a Twitter-like, Reddit-like, or short-video environment
...
- **Platform Types**: Choose between Twitter-like, Reddit-like, or short-video environments
