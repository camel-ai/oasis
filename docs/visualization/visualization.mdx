...
OASIS also supports short-video analysis workflows for TikTok-style simulations.

### Available Outputs

- feed-level metric charts
- livestream attention and retention charts
...
These tools are useful for studying creator growth, traffic-pool mobility, negative-feedback suppression, and livestream retention over time.
