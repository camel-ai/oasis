...
Uses httpx + BeautifulSoup. Falls back gracefully on JS-heavy sites.
"""
...
async def scrape(url: str, follow_links: int = 2) -> ScrapeResult:
    """
...
async def _fetch_page(url: str) -> ScrapeResult:
    try:
