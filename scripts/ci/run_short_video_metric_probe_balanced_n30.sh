...
OUT_DIR="${1:-${ROOT_DIR}/examples/experiment/short_video_negative_feedback/output_metric_probe_balanced_n30}"

echo "[metric-probe-balanced-n30] output dir: ${OUT_DIR}"
mkdir -p "${OUT_DIR}"
...
print("[metric-probe-balanced-n30] key metrics:")
for metric in [
...
echo "[metric-probe-balanced-n30] done."
echo "[metric-probe-balanced-n30] outputs:"
